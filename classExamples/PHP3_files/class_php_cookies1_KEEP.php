<?PHP
 ...
 //      setcookie('composition', $composition);
		...
		setcookie('composer',$composer, time() + 5*60);
		setcookie('composition',$composition, time() + 5*60);
...
<form id="cookies1" name="cookies1" method="post"
    action="http://i6.cims.nyu.edu/~nh2/PHP3_files/class_php_cookies1_KEEP.php">
...
<fieldset id="music">    
    <p>Choose the composer: <select name="composer" id="composer">
      ...
      <option value="Opera" selected="selected">Opera</option>
